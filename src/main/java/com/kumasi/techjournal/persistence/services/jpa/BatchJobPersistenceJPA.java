...
/**
 * JPA implementation for basic persistence operations ( entity "BatchJob" )
 * 
 * @author Telosys Tools Generator
 *
 */
public class BatchJobPersistenceJPA extends GenericJpaService<BatchJobEntity, Integer> implements BatchJobPersistence {

	/**
	 * Constructor
	 */
	public BatchJobPersistenceJPA() {
	...
	public long countAll() {
		...
		JpaOperation operation = new JpaOperation() {
			...
			public Object exectue(EntityManager em) throws PersistenceException {
				Query query = em.createNamedQuery("BatchJobEntity.countAll");
