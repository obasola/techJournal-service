...
public class SqlScriptEntityMock {
	 ...
	 * @return
	 */
	public SqlScriptEntity createInstance() {
		// Primary Key values
	 ...
	 * @return
	 */
	public SqlScriptEntity createInstance( Integer id ) {
		SqlScriptEntity entity = new SqlScriptEntity();
		// Init Primary Key fields
		entity.setId( id) ;
		// Init Data fields
		entity.setDatabaseName( mockValues.nextString(45) ) ; // java.lang.String 
		entity.setScript( mockValues.nextString(16777215) ) ; // java.lang.String 
	 ...
	 * @return
	 */
	public List<SqlScriptEntity> createList(int count) {
		List<SqlScriptEntity> list = new LinkedList<SqlScriptEntity>();		
